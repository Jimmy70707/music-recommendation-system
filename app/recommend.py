...
try:
    df = joblib.load('F:\Mohamed\Education\AI Projects\music recomendation\src\df_cleaned.pkl')
    cosine_sim = joblib.load('F:\Mohamed\Education\AI Projects\music recomendation\src\cosine_sim.pkl')
